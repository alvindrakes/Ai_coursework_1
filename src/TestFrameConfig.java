import g53dsm.satheuristics.SimulatedAnnealing;
import g53dsm.satheuristics.SATHeuristic;
import g53dsm.satheuristics.RandomMutation;
...
public class TestFrameConfig {
	 ...
	 */
	protected final int TOTAL_RUNS  = 21;
	...
	public static SATHeuristic getSATHeuristic(int heuristicID, Random random) {
		...
		switch(heuristicID) {
		case 0:
			heuristic = new SimulatedAnnealing(random);
			break;
		case 1:
			heuristic = new RandomMutation(random);
			break;
		default:
